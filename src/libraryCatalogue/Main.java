...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CopyOfBook copyOfBook1 = new CopyOfBook("To kill a mockingbird", "Lee, Harper",
                "978-0446310789", "LEE Har to", Language.ENGLISH);
        CopyOfBook copyOfBook2 = new CopyOfBook("Of mice and men", "Steinbeck, John",
                "978-0140177398", "STE Joh of", Language.ENGLISH);
        CopyOfBook copyOfBook3 = new CopyOfBook("Les trois mousquetaires", "Dumas, Alexandre",
                "978-2253008880", "DUM Ale tr", Language.FRENCH);
        CopyOfBook copyOfBook4 = new CopyOfBook("Une fille comme elle", "Levy, Marc",
